...
import { Train, ShieldCheck, AlertCircle, Clock, Calendar, Menu } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background relative flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <button
          ...
          className="lg:hidden fixed bottom-6 right-6 z-50 p-4 bg-primary text-primary-foreground rounded-full shadow-xl hover:scale-110 active:scale-95 transition-all"
        >
          <Menu className="w-6 h-6" />
        </button>

        <MenuNavigation isOpen={isSidebarOpen} />
